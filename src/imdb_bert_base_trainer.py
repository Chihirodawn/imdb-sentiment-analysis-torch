...
RESULT_PATH = "./result/bert_base_trainer.csv"
OUTPUT_DIR = "./checkpoint/bert_base_trainer"
LOGGING_DIR = "./logs/bert_base_trainer"
MAX_LENGTH = 512
RANDOM_SEED = 42
...
def main():
    ...
    pd.DataFrame(
        {"id": test["id"], "sentiment": test_pred}
    ).to_csv(RESULT_PATH, index=False, quoting=3)
